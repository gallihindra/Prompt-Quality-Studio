...
export function Header() {
  return (
    <header className="relative z-20 border-b border-line/80 bg-paper/90 backdrop-blur">
      <div className="container-page flex h-[72px] items-center justify-between">
        <Link href="/" className="flex items-center gap-3" aria-label="Prompt Quality Studio home">
          <span className="grid h-8 w-8 place-items-center rounded-lg bg-leaf-900 text-[11px] font-bold tracking-tight text-white">
            PQ
          </span>
